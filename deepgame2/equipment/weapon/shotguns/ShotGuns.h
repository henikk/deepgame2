...
class ShotGuns : public Weapon
{
public:
	ShotGuns(std::string _pathToTexture, std::string _pathToShellTexture, std::string _pathToParticleTexture, std::vector<std::string> _pathsToSounds);
	virtual ~ShotGuns() override;
